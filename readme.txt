...
GA4  Server-Side  Tracking  for  WooCommerce  provides  comprehensive  server-side  tracking  for  your  WooCommerce  store  using  the  Google  Analytics  4  Measurement  Protocol.  This  ensures  accurate  tracking  that  bypasses  ad  blockers  and  provides  complete  ecommerce  insights.
...
=  1.0.0  =
Initial  release  of  GA4  Server-Side  Tracking  for  WooCommerce  plugin.
...
Original  Repository:  https://github.com/io-woo-invoicer/server-side-tracking-for-woocommerce-with-ga4-and-meta-pixel
